        ...
        <header id="masthead" class="site-header">
            <nav id="site-navigation" class="main-navigation">
                ...
                <ul>
                    ...
                    <li><img class="ChatNoir" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/ChatNoir.png" alt="chat noir" /></li>
                    <li><img class="ChatOrange" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/ChatOrange.png" alt="chat orange" /></li>
                </ul>
            </nav>
        </header><!-- #masthead -->